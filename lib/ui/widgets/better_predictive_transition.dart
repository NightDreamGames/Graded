...
/// back to [SharedAxisTransitionBuilder].
///
...
class BetterPredictiveBackPageTransitionsBuilder extends PageTransitionsBuilder {
  /// Creates an instance of a [PageTransitionsBuilder] that matches Android U's
  /// predictive back transition.
  const BetterPredictiveBackPageTransitionsBuilder();
  ...
  Widget buildTransitions<T>(
    ...
    return _PredictiveBackGestureDetector(
      ...
      builder: (BuildContext context) {
        ...
        // programmatic navigation, fall back to SharedAxisTransitionBuilder.
        ...
        return const SharedAxisTransitionBuilder().buildTransitions(
          route,
          context,
          animation,
          secondaryAnimation,
